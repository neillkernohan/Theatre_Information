...
class InventoryItemForm(FlaskForm):
    ...
    qty_available = IntegerField('Available', validators=[InputRequired(), NumberRange(min=0)], default=0)
    qty_in_use = IntegerField('In Use', validators=[InputRequired(), NumberRange(min=0)], default=0)
    qty_needs_repair = IntegerField('Needs Repair', validators=[InputRequired(), NumberRange(min=0)], default=0)
    qty_retired = IntegerField('Retired', validators=[InputRequired(), NumberRange(min=0)], default=0)
